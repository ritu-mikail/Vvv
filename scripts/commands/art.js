...
module.exports.run = async ({ api, event, args }) => {
 ...
 try {
    const lim = await axios.get(`https://rehatdesu.xyz/api/imagine/niji?prompt=${encodeURIComponent(prompt)}.&aspectRatio=${aspectRatio}&style=${style}&preset=${preset}&apikey=gaysex`);
