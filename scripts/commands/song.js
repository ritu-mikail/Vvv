...
module.exports.handleReply = async function ({ api, event, handleReply }) {
    ...
    try {
        ...
        var data = await downloadMusicFromYoutube('https://youtube-music-sooty.vercel.app/kshitiz?url=${encodeURIComponent(shortUrl)}' + handleReply.link[event.body -1], path);
